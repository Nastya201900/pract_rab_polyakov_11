...
def calcTree ( Tree ):
  if Tree.left == None:
    try:
      ...
      val = None  # неверное выражение
    return val
  else:
    if Tree.left == None or Tree.right == None:   # неверное выражение
      return None
    n1 = calcTree ( Tree.left )
    n2 = calcTree ( Tree.right )
    if n1 == None or n2 == None:   # неверное выражение
      res = None
